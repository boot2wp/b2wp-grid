...
const SetMobileAreas = ({ mobileAreas, setMobileAreas, setHasUpdated }) => {
    ...
    return (
        <TextareaControl
            ...
            help={__("Value for grid-template-areas on mobile widths", 'b2wp-grid')}
            value={mobileAreas}
...
const SetNumberNamedAreas = ({ numberNamedAreas, setNumberNamedAreas, setHasUpdated }) => {
...
const SetMobileBreakpoint = ({ mobileBreakpoint, setMobileBreakpoint, setHasUpdated }) => {
    ...
    return (
        <ToolsPanel label={__('Set Mobile Breakpoint')} resetAll={resetAll}>
            <SingleColumnItem
